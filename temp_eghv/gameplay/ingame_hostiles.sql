...
UPDATE GoodyHutSubTypes_EGHV
SET Tier = CASE
	WHEN GoodyHut = 'GOODYHUT_ALTERNATE' THEN 3
...
UPDATE GoodyHutSubTypes_EGHV
SET TierType = CASE
	WHEN Tier = 0 THEN '''DISABLED'''
	WHEN Tier = 1 THEN 'Common'
	WHEN Tier = 2 THEN 'Uncommon'
	WHEN Tier = 3 THEN 'Rare'
	WHEN Tier = 4 THEN 'Legendary'
	WHEN Tier = 5 THEN 'Mythic'
	ELSE '''INVALID'''
END;
...
UPDATE HostileUnits SET LightCavalry = 'UNIT_BARBARIAN_HORSE_ARCHER' WHERE Era = 0;
UPDATE HostileUnits SET HeavyCavalry = 'UNIT_BARBARIAN_HORSEMAN' WHERE Era = 0;
