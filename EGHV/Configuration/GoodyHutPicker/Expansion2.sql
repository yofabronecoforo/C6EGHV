...
VALUES
    ...
    ('GOODYHUT_SECRETS', 'LOC_EGHV_GOODYHUT_VILLAGER_SECRETS_FAVOR_NAME', 'GOODYHUT_VILLAGER_SECRETS_FAVOR', 'LOC_EGHV_GOODYHUT_VILLAGER_SECRETS_FAVOR_DESC', 'ICON_IMPROVEMENT_GOODY_HUT', 500),
    -- EGHV : diplomacy type
    ('GOODYHUT_DIPLOMACY', 'LOC_EGHV_GOODYHUT_SMALL_FAVOR_NAME', 'GOODYHUT_SMALL_FAVOR', 'LOC_EGHV_GOODYHUT_SMALL_FAVOR_DESC', 'ICON_EGHV_GOODY_DIPLOMACY', 100),
    ('GOODYHUT_DIPLOMACY', 'LOC_EGHV_GOODYHUT_MEDIUM_FAVOR_NAME', 'GOODYHUT_MEDIUM_FAVOR', 'LOC_EGHV_GOODYHUT_MEDIUM_FAVOR_DESC', 'ICON_EGHV_GOODY_DIPLOMACY', 200),
    ('GOODYHUT_DIPLOMACY', 'LOC_EGHV_GOODYHUT_LARGE_FAVOR_NAME', 'GOODYHUT_LARGE_FAVOR', 'LOC_EGHV_GOODYHUT_LARGE_FAVOR_DESC', 'ICON_EGHV_GOODY_DIPLOMACY', 300),
    ('GOODYHUT_DIPLOMACY', 'LOC_EGHV_GOODYHUT_HUGE_FAVOR_NAME', 'GOODYHUT_HUGE_FAVOR', 'LOC_EGHV_GOODYHUT_HUGE_FAVOR_DESC', 'ICON_EGHV_GOODY_DIPLOMACY', 400),
    -- EGHV : resources type
    ...
    -- meteor type
    ('METEOR_GOODIES', 'LOC_EGHV_GOODYHUT_METEOR_GRANT_GOODIES_NAME', 'METEOR_GRANT_GOODIES', 'LOC_EGHV_GOODYHUT_METEOR_GRANT_GOODIES_DESC', 'ICON_EGHV_GOODY_METEOR', 500);
