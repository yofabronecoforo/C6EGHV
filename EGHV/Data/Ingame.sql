...
-- 
-- UPDATE GoodyHuts SET Weight = 630 WHERE GoodyHutType = 'GOODYHUT_CULTURE';
-- UPDATE GoodyHuts SET Weight = 630 WHERE GoodyHutType = 'GOODYHUT_GOLD';
-- UPDATE GoodyHuts SET Weight = 630 WHERE GoodyHutType = 'GOODYHUT_FAITH';
-- UPDATE GoodyHuts SET Weight = 630 WHERE GoodyHutType = 'GOODYHUT_MILITARY';
-- UPDATE GoodyHuts SET Weight = 630 WHERE GoodyHutType = 'GOODYHUT_SCIENCE';
-- UPDATE GoodyHuts SET Weight = 630 WHERE GoodyHutType = 'GOODYHUT_SURVIVORS';

-- 
REPLACE INTO Types (Type, Kind) VALUES ('GOODYHUT_HOSTILES', 'KIND_GOODY_HUT');

-- 
REPLACE INTO GoodyHuts (GoodyHutType, Weight) VALUES ('GOODYHUT_HOSTILES', 630);
...
UPDATE GoodyHutSubTypes SET Weight = 320, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_ONE_CIVIC_BOOST';       -- defaults : Weight = 55
UPDATE GoodyHutSubTypes SET Weight = 160, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_TWO_CIVIC_BOOSTS';      -- defaults : Weight = 30, Turn = 30

-- Make "one relic" a Faith-type reward (was Culture-type); adjust its weight value and other properties
UPDATE GoodyHutSubTypes SET GoodyHut = 'GOODYHUT_FAITH', Weight = 40, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_ONE_RELIC';              -- defaults : Weight = 15

-- Adjust the weight value and other properties assigned to individual existing Faith-type rewards
UPDATE GoodyHutSubTypes SET Weight = 320, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_SMALL_FAITH';               -- defaults : Weight = 55, Turn = 20
UPDATE ModifierArguments SET Value = 20 WHERE ModifierId = 'GOODY_FAITH_SMALL_MODIFIER' AND Name = 'Amount';    -- defaults : Value = 20
UPDATE GoodyHutSubTypes SET Weight = 160, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_MEDIUM_FAITH';              -- defaults : Weight = 30, Turn = 40
UPDATE ModifierArguments SET Value = 60 WHERE ModifierId = 'GOODY_FAITH_MEDIUM_MODIFIER' AND Name = 'Amount';   -- defaults : Value = 60
UPDATE GoodyHutSubTypes SET Weight = 80, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_LARGE_FAITH';               -- defaults : Weight = 15, Turn = 60
...
UPDATE GoodyHutSubTypes SET Weight = 320, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_SMALL_GOLD';                -- defaults : Weight = 55
UPDATE ModifierArguments SET Value = 40 WHERE ModifierId = 'GOODY_GOLD_SMALL_MODIFIER' AND Name = 'Amount';     -- defaults : Value = 40
UPDATE GoodyHutSubTypes SET Weight = 160, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_MEDIUM_GOLD';               -- defaults : Weight = 30, Turn = 20
UPDATE ModifierArguments SET Value = 80 WHERE ModifierId = 'GOODY_GOLD_MEDIUM_MODIFIER' AND Name = 'Amount';    -- defaults : Value = 75
UPDATE GoodyHutSubTypes SET Weight = 80, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_LARGE_GOLD';                -- defaults : Weight = 15, Turn = 40
...
UPDATE GoodyHutSubTypes SET Weight = 160, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_EXPERIENCE';                              -- defaults : Weight = 30
UPDATE GoodyHutSubTypes SET Weight = 80, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_SCOUT';                                   -- defaults : Weight = 40

-- Adjust the weight value and other properties assigned to individual existing Science-type rewards
UPDATE GoodyHutSubTypes SET Weight = 320, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_ONE_TECH_BOOST';        -- defaults : Weight = 55
UPDATE GoodyHutSubTypes SET Weight = 160, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_TWO_TECH_BOOSTS';       -- defaults : Weight = 30, Turn = 30
UPDATE GoodyHutSubTypes SET Weight = 80, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_ONE_TECH';              -- defaults : Weight = 15, Turn = 50

-- Adjust the weight value and other properties assigned to individual existing Survivor-type rewards
UPDATE GoodyHutSubTypes SET Weight = 320, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_ADD_POP';           -- defaults : Weight = 40
UPDATE GoodyHutSubTypes SET Weight = 160, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_BUILDER';     -- defaults : Weight = 35
UPDATE GoodyHutSubTypes SET Weight = 80, Turn = 0, Trader = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_TRADER';      -- defaults : Weight = 25, Turn = 15
UPDATE GoodyHutSubTypes SET Weight = 40, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_SETTLER';      -- defaults : Weight = 0
...
VALUES
    -- Culture
    ('GOODYHUT_CULTURE', 'GOODYHUT_ONE_CIVIC', 'LOC_GOODYHUT_CULTURE_ONE_CIVIC_DESCRIPTION', 80, 0, 1, 1, 'GOODY_CULTURE_GRANT_ONE_CIVIC'),
    ('GOODYHUT_CULTURE', 'GOODYHUT_TWO_CIVICS', 'LOC_GOODYHUT_CULTURE_TWO_CIVICS_DESCRIPTION', 40, 0, 1, 1, 'GOODY_CULTURE_GRANT_TWO_CIVICS'),
    ...
    -- Gold
    ('GOODYHUT_GOLD', 'GOODYHUT_ADD_TRADE_ROUTE', 'LOC_GOODYHUT_ADD_TRADE_ROUTE_DESCRIPTION', 40, 0, 1, 1, 'GOODY_GOLD_ADD_TRADE_ROUTE'),
    ...
    -- Military
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_WARRIOR', 'LOC_GOODYHUT_MILITARY_GRANT_MELEE_UNIT_DESCRIPTION', 80, 0, 1, 1, 'GOODY_MILITARY_GRANT_WARRIOR'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_SLINGER', 'LOC_GOODYHUT_MILITARY_GRANT_RANGED_UNIT_DESCRIPTION', 80, 0, 1, 1, 'GOODY_MILITARY_GRANT_SLINGER'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_SPEARMAN', 'LOC_GOODYHUT_MILITARY_GRANT_ANTI_CAVALRY_UNIT_DESCRIPTION', 80, 0, 1, 1, 'GOODY_MILITARY_GRANT_SPEARMAN'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_MILITARY_ENGINEER', 'LOC_GOODYHUT_MILITARY_GRANT_MILITARY_ENGINEER_DESCRIPTION', 40, 0, 1, 1, 'GOODY_MILITARY_GRANT_MILITARY_ENGINEER'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_MEDIC', 'LOC_GOODYHUT_MILITARY_GRANT_MEDIC_DESCRIPTION', 40, 0, 1, 1, 'GOODY_MILITARY_GRANT_MEDIC'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_HORSEMAN', 'LOC_GOODYHUT_MILITARY_GRANT_LIGHT_CAVALRY_UNIT_DESCRIPTION', 20, 0, 1, 1, 'GOODY_MILITARY_GRANT_HORSEMAN'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_HEAVY_CHARIOT', 'LOC_GOODYHUT_MILITARY_GRANT_HEAVY_CAVALRY_UNIT_DESCRIPTION', 20, 0, 1, 1, 'GOODY_MILITARY_GRANT_HEAVY_CHARIOT'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_SMALL_CHANGE_PRODUCTION', 'LOC_GOODYHUT_PRODUCTION_SMALL_CHANGE_DESCRIPTION', 20, 0, 1, 1, 'GOODY_PRODUCTION_SMALL_CHANGE'),
    ...
    -- Science
    ('GOODYHUT_SCIENCE', 'GOODYHUT_TWO_TECHS', 'LOC_GOODYHUT_SCIENCE_TWO_TECHS_DESCRIPTION', 40, 0, 1, 1, 'GOODY_SCIENCE_GRANT_TWO_TECHS'),
    ...
    -- Hostiles
    ('GOODYHUT_HOSTILES', 'GOODYHUT_SPAWN_HOSTILE_VILLAGERS', 'LOC_GOODYHUT_SPAWN_HOSTILE_VILLAGERS_DESCRIPTION', 630, 0, 1, 1, 'GOODY_SPAWN_HOSTILES');
