...
VALUES
    -- governors type
    ('GOODYHUT_GOVERNORS', 'GOODYHUT_ONE_GOVERNOR_TITLE', 'LOC_GOODYHUT_GOVERNORS_ONE_TITLE_DESCRIPTION', 55, 0, 1, 1, 'GOODY_TITLES_GRANT_ONE'),
    ...
    ('GOODYHUT_GOVERNORS', 'GOODYHUT_THREE_GOVERNOR_TITLES', 'LOC_GOODYHUT_GOVERNORS_THREE_TITLES_DESCRIPTION', 10, 0, 1, 1, 'GOODY_TITLES_GRANT_THREE'),
    ('GOODYHUT_GOVERNORS', 'GOODYHUT_FOUR_GOVERNOR_TITLES', 'LOC_GOODYHUT_GOVERNORS_FOUR_TITLES_DESCRIPTION', 5, 0, 1, 1, 'GOODY_TITLES_GRANT_FOUR');
