...
UPDATE GoodyHutSubTypes SET Weight = 0, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_EXPERIENCE';                              -- defaults : Weight = 30
...
UPDATE GoodyHutSubTypes SET Weight = 55, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_SCOUT';                                   -- defaults : Weight = 40
...
VALUES
    ...
    -- Military
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_WARRIOR', 'LOC_GOODYHUT_MILITARY_GRANT_MELEE_UNIT_DESCRIPTION', 25, 0, 1, 1, 'GOODY_MILITARY_GRANT_WARRIOR'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_SLINGER', 'LOC_GOODYHUT_MILITARY_GRANT_RANGED_UNIT_DESCRIPTION', 20, 0, 1, 1, 'GOODY_MILITARY_GRANT_SLINGER'),
    -- (Anti) Cavalry
    ('GOODYHUT_CAVALRY', 'GOODYHUT_GRANT_SPEARMAN', 'LOC_GOODYHUT_MILITARY_GRANT_ANTI_CAVALRY_UNIT_DESCRIPTION', 50, 0, 1, 1, 'GOODY_MILITARY_GRANT_SPEARMAN'),
    ('GOODYHUT_CAVALRY', 'GOODYHUT_GRANT_HEAVY_CHARIOT', 'LOC_GOODYHUT_MILITARY_GRANT_HEAVY_CAVALRY_UNIT_DESCRIPTION', 25, 0, 1, 1, 'GOODY_MILITARY_GRANT_HEAVY_CHARIOT'),
    ('GOODYHUT_CAVALRY', 'GOODYHUT_GRANT_HORSEMAN', 'LOC_GOODYHUT_MILITARY_GRANT_LIGHT_CAVALRY_UNIT_DESCRIPTION', 25, 0, 1, 1, 'GOODY_MILITARY_GRANT_HORSEMAN'),
    -- Science
    ...
    -- Promotions
    ('GOODYHUT_PROMOTIONS', 'GOODYHUT_SMALL_EXPERIENCE', 'LOC_GOODYHUT_EXPERIENCE_DESCRIPTION', 40, 0, 1, 1, 'GOODY_EXPERIENCE_SMALL_MODIFIER'),
    ('GOODYHUT_PROMOTIONS', 'GOODYHUT_MEDIUM_EXPERIENCE', 'LOC_GOODYHUT_EXPERIENCE_DESCRIPTION', 30, 0, 1, 1, 'GOODY_EXPERIENCE_MEDIUM_MODIFIER'),
    ('GOODYHUT_PROMOTIONS', 'GOODYHUT_LARGE_EXPERIENCE', 'LOC_GOODYHUT_EXPERIENCE_DESCRIPTION', 20, 0, 1, 1, 'GOODY_EXPERIENCE_LARGE_MODIFIER'),
    ('GOODYHUT_PROMOTIONS', 'GOODYHUT_HUGE_EXPERIENCE', 'LOC_GOODYHUT_EXPERIENCE_DESCRIPTION', 10, 0, 1, 1, 'GOODY_EXPERIENCE_HUGE_MODIFIER'),
    -- Secrets
    ...
    -- Support
    ('GOODYHUT_SUPPORT', 'GOODYHUT_GRANT_BATTERING_RAM', 'LOC_GOODYHUT_MILITARY_GRANT_BATTERING_RAM_DESCRIPTION', 40, 0, 1, 1, 'GOODY_MILITARY_GRANT_BATTERING_RAM'),
    ('GOODYHUT_SUPPORT', 'GOODYHUT_GRANT_CATAPULT', 'LOC_GOODYHUT_MILITARY_GRANT_CATAPULT_DESCRIPTION', 30, 0, 1, 1, 'GOODY_MILITARY_GRANT_CATAPULT'),
    ('GOODYHUT_SUPPORT', 'GOODYHUT_GRANT_MILITARY_ENGINEER', 'LOC_GOODYHUT_MILITARY_GRANT_MILITARY_ENGINEER_DESCRIPTION', 20, 0, 1, 1, 'GOODY_MILITARY_GRANT_MILITARY_ENGINEER'),
    ('GOODYHUT_SUPPORT', 'GOODYHUT_GRANT_MEDIC', 'LOC_GOODYHUT_MILITARY_GRANT_MEDIC_DESCRIPTION', 10, 0, 1, 1, 'GOODY_MILITARY_GRANT_MEDIC');
