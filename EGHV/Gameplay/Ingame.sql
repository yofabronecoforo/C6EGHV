...
UPDATE GoodyHutSubTypes SET Weight = 55, Turn = 0, MinOneCity = 0, RequiresUnit = 0, Description = 'LOC_GOODYHUT_CULTURE_ONE_CIVIC_BOOST_DESCRIPTION' WHERE SubTypeGoodyHut = 'GOODYHUT_ONE_CIVIC_BOOST';
-- adjust existing Culture-type "two Civic boosts" reward
UPDATE GoodyHutSubTypes SET Weight = 30, Turn = 0, MinOneCity = 0, RequiresUnit = 0, Description = 'LOC_GOODYHUT_CULTURE_TWO_CIVIC_BOOSTS_DESCRIPTION' WHERE SubTypeGoodyHut = 'GOODYHUT_TWO_CIVIC_BOOSTS';

-- adjust existing Faith-type "small Faith cache" reward
UPDATE GoodyHutSubTypes SET Weight = 55, Turn = 0, MinOneCity = 0, RequiresUnit = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_SMALL_FAITH';               -- defaults : Weight = 55, Turn = 20
...
UPDATE GoodyHutSubTypes SET Weight = 30, Turn = 0, MinOneCity = 0, RequiresUnit = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_MEDIUM_FAITH';              -- defaults : Weight = 30, Turn = 40
...
UPDATE GoodyHutSubTypes SET Weight = 10, Turn = 0, MinOneCity = 0, RequiresUnit = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_LARGE_FAITH';               -- defaults : Weight = 15, Turn = 60
...
UPDATE GoodyHutSubTypes SET GoodyHut = 'GOODYHUT_FAITH', Weight = 5, Turn = 0, MinOneCity = 1, RequiresUnit = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_ONE_RELIC';              -- defaults : Weight = 15

-- adjust existing Gold-type "small Gold cache" reward
UPDATE GoodyHutSubTypes SET Weight = 55, Turn = 0, MinOneCity = 0, RequiresUnit = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_SMALL_GOLD';                -- defaults : Weight = 55
...
UPDATE GoodyHutSubTypes SET Weight = 30, Turn = 0, MinOneCity = 0, RequiresUnit = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_MEDIUM_GOLD';               -- defaults : Weight = 30, Turn = 20
...
UPDATE GoodyHutSubTypes SET Weight = 10, Turn = 0, MinOneCity = 0, RequiresUnit = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_LARGE_GOLD';                -- defaults : Weight = 15, Turn = 40
...
REPLACE INTO DisabledGoodyHutSubTypes SELECT * FROM GoodyHutSubTypes WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_EXPERIENCE';
DELETE FROM GoodyHutSubTypes WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_EXPERIENCE';
...
REPLACE INTO DisabledGoodyHutSubTypes SELECT * FROM GoodyHutSubTypes WHERE SubTypeGoodyHut = 'GOODYHUT_HEAL';
DELETE FROM GoodyHutSubTypes WHERE SubTypeGoodyHut = 'GOODYHUT_HEAL';
-- enable "upgrade unit" reward and make it a custom Promotions-type reward
UPDATE GoodyHutSubTypes SET GoodyHut = 'GOODYHUT_PROMOTIONS', Weight = 5, Turn = 0, UpgradeUnit = 0, MinOneCity = 0, RequiresUnit = 1, ModifierID = 'GOODY_EGHV_DUMMY_REWARD' WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_UPGRADE';
-- adjust existing Military-type "grant scout" reward; this reward now grants an Era-appropriate recon unit
UPDATE GoodyHutSubTypes SET Weight = 55, Turn = 0, MinOneCity = 0, RequiresUnit = 0, ModifierID = 'GOODY_EGHV_DUMMY_REWARD' WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_SCOUT';

-- existing Science-type rewards
UPDATE GoodyHutSubTypes SET Weight = 55, Turn = 0, MinOneCity = 0, RequiresUnit = 0, Description = 'LOC_GOODYHUT_SCIENCE_ONE_TECH_BOOST_DESCRIPTION' WHERE SubTypeGoodyHut = 'GOODYHUT_ONE_TECH_BOOST';
UPDATE GoodyHutSubTypes SET Weight = 30, Turn = 0, MinOneCity = 0, RequiresUnit = 0, Description = 'LOC_GOODYHUT_SCIENCE_TWO_TECH_BOOSTS_DESCRIPTION' WHERE SubTypeGoodyHut = 'GOODYHUT_TWO_TECH_BOOSTS';
UPDATE GoodyHutSubTypes SET Weight = 10, Turn = 0, MinOneCity = 0, RequiresUnit = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_ONE_TECH';

-- existing Survivor-type rewards
UPDATE GoodyHutSubTypes SET Weight = 55, Turn = 0, MinOneCity = 1, RequiresUnit = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_ADD_POP';
UPDATE GoodyHutSubTypes SET Weight = 30, Turn = 0, MinOneCity = 1, RequiresUnit = 0, Description = 'LOC_GOODYHUT_SURVIVORS_GRANT_BUILDER_DESCRIPTION', ModifierID = 'GOODY_EGHV_DUMMY_REWARD' WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_BUILDER';
UPDATE GoodyHutSubTypes SET Weight = 10, Turn = 0, MinOneCity = 1, RequiresUnit = 0, Description = 'LOC_GOODYHUT_SURVIVORS_GRANT_TRADER_DESCRIPTION' WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_TRADER';
UPDATE GoodyHutSubTypes SET Weight = 5, Turn = 0, MinOneCity = 0, RequiresUnit = 0, Description = 'LOC_GOODYHUT_SURVIVORS_GRANT_SETTLER_DESCRIPTION', ModifierID = 'GOODY_EGHV_DUMMY_REWARD' WHERE SubTypeGoodyHut = 'GOODYHUT_GRANT_SETTLER';
...
VALUES
    -- Culture
    ('GOODYHUT_CULTURE', 'GOODYHUT_ONE_CIVIC', 'LOC_GOODYHUT_CULTURE_ONE_CIVIC_DESCRIPTION', 10, 0, 0, 0, 'GOODY_CULTURE_GRANT_ONE_CIVIC'),
    ('GOODYHUT_CULTURE', 'GOODYHUT_TWO_CIVICS', 'LOC_GOODYHUT_CULTURE_TWO_CIVICS_DESCRIPTION', 5, 0, 0, 0, 'GOODY_CULTURE_GRANT_TWO_CIVICS'),
    -- Gold
    ('GOODYHUT_GOLD', 'GOODYHUT_ADD_TRADE_ROUTE', 'LOC_GOODYHUT_ADD_TRADE_ROUTE_DESCRIPTION', 5, 0, 0, 0, 'GOODY_GOLD_ADD_TRADE_ROUTE'),
    -- Military
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_WARRIOR', 'LOC_GOODYHUT_MILITARY_GRANT_MELEE_UNIT_DESCRIPTION', 30, 0, 0, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_SLINGER', 'LOC_GOODYHUT_MILITARY_GRANT_RANGED_UNIT_DESCRIPTION', 30, 0, 0, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_SPEARMAN', 'LOC_GOODYHUT_MILITARY_GRANT_ANTI_CAVALRY_UNIT_DESCRIPTION', 30, 0, 0, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_HEAVY_CHARIOT', 'LOC_GOODYHUT_MILITARY_GRANT_HEAVY_CAVALRY_UNIT_DESCRIPTION', 10, 0, 0, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_HORSEMAN', 'LOC_GOODYHUT_MILITARY_GRANT_LIGHT_CAVALRY_UNIT_DESCRIPTION', 10, 0, 0, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_BATTERING_RAM', 'LOC_GOODYHUT_MILITARY_GRANT_BATTERING_RAM_DESCRIPTION', 5, 0, 0, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_CATAPULT', 'LOC_GOODYHUT_MILITARY_GRANT_CATAPULT_DESCRIPTION', 5, 0, 0, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_MILITARY_ENGINEER', 'LOC_GOODYHUT_MILITARY_GRANT_MILITARY_ENGINEER_DESCRIPTION', 5, 0, 0, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    -- Science
    ('GOODYHUT_SCIENCE', 'GOODYHUT_TWO_TECHS', 'LOC_GOODYHUT_SCIENCE_TWO_TECHS_DESCRIPTION', 5, 0, 0, 0, 'GOODY_SCIENCE_GRANT_TWO_TECHS'),
    -- Abilities
    ('GOODYHUT_ABILITIES', 'GOODYHUT_IMPROVED_SIGHT', 'LOC_GOODYHUT_IMPROVED_SIGHT_DESCRIPTION', 55, 0, 0, 1, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_ABILITIES', 'GOODYHUT_IMPROVED_HEALING', 'LOC_GOODYHUT_IMPROVED_HEALING_DESCRIPTION', 30, 0, 0, 1, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_ABILITIES', 'GOODYHUT_IMPROVED_MOVEMENT', 'LOC_GOODYHUT_IMPROVED_MOVEMENT_DESCRIPTION', 10, 0, 0, 1, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_ABILITIES', 'GOODYHUT_IMPROVED_STRENGTH', 'LOC_GOODYHUT_IMPROVED_STRENGTH_DESCRIPTION', 5, 0, 0, 1, 'GOODY_EGHV_DUMMY_REWARD'),
    -- Envoys
    ('GOODYHUT_ENVOYS', 'GOODYHUT_ONE_ENVOY', 'LOC_GOODYHUT_ENVOYS_GRANT_ONE_DESCRIPTION', 55, 0, 0, 0, 'GOODY_ENVOYS_GRANT_ONE'),
    ('GOODYHUT_ENVOYS', 'GOODYHUT_TWO_ENVOYS', 'LOC_GOODYHUT_ENVOYS_GRANT_TWO_DESCRIPTION', 30, 0, 0, 0, 'GOODY_ENVOYS_GRANT_TWO'),
    ('GOODYHUT_ENVOYS', 'GOODYHUT_THREE_ENVOYS', 'LOC_GOODYHUT_ENVOYS_GRANT_THREE_DESCRIPTION', 10, 0, 0, 0, 'GOODY_ENVOYS_GRANT_THREE'),
    ('GOODYHUT_ENVOYS', 'GOODYHUT_FOUR_ENVOYS', 'LOC_GOODYHUT_ENVOYS_GRANT_FOUR_DESCRIPTION', 5, 0, 0, 0, 'GOODY_ENVOYS_GRANT_FOUR'),
    -- Hostiles
    ('GOODYHUT_HOSTILES', 'GOODYHUT_LOW_HOSTILITY_VILLAGERS', 'LOC_GOODYHUT_HOSTILE_VILLAGERS_DESCRIPTION', 55, 0, 0, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_HOSTILES', 'GOODYHUT_MID_HOSTILITY_VILLAGERS', 'LOC_GOODYHUT_HOSTILE_VILLAGERS_DESCRIPTION', 30, 0, 0, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_HOSTILES', 'GOODYHUT_HIGH_HOSTILITY_VILLAGERS', 'LOC_GOODYHUT_HOSTILE_VILLAGERS_DESCRIPTION', 10, 0, 0, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_HOSTILES', 'GOODYHUT_MAX_HOSTILITY_VILLAGERS', 'LOC_GOODYHUT_HOSTILE_VILLAGERS_DESCRIPTION', 5, 0, 0, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    -- Promotions
    ('GOODYHUT_PROMOTIONS', 'GOODYHUT_SMALL_EXPERIENCE', 'LOC_GOODYHUT_SMALL_EXPERIENCE_DESCRIPTION', 55, 0, 0, 1, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_PROMOTIONS', 'GOODYHUT_MEDIUM_EXPERIENCE', 'LOC_GOODYHUT_MEDIUM_EXPERIENCE_DESCRIPTION', 30, 0, 0, 1, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_PROMOTIONS', 'GOODYHUT_LARGE_EXPERIENCE', 'LOC_GOODYHUT_LARGE_EXPERIENCE_DESCRIPTION', 10, 0, 0, 1, 'GOODY_EGHV_DUMMY_REWARD'),
    -- ('GOODYHUT_PROMOTIONS', 'GOODYHUT_HUGE_EXPERIENCE', 'LOC_GOODYHUT_HUGE_EXPERIENCE_DESCRIPTION', 5, 0, 0, 1, 'GOODY_EGHV_DUMMY_REWARD'),
    -- Secrets
    ('GOODYHUT_SECRETS', 'GOODYHUT_VILLAGER_SECRETS_AMENITIES', 'LOC_GOODYHUT_VILLAGER_SECRETS_DESCRIPTION', 100, 0, 1, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_SECRETS', 'GOODYHUT_VILLAGER_SECRETS_CULTURE', 'LOC_GOODYHUT_VILLAGER_SECRETS_DESCRIPTION', 100, 0, 1, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_SECRETS', 'GOODYHUT_VILLAGER_SECRETS_FAITH', 'LOC_GOODYHUT_VILLAGER_SECRETS_DESCRIPTION', 100, 0, 1, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_SECRETS', 'GOODYHUT_VILLAGER_SECRETS_FOOD', 'LOC_GOODYHUT_VILLAGER_SECRETS_DESCRIPTION', 100, 0, 1, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_SECRETS', 'GOODYHUT_VILLAGER_SECRETS_GOLD', 'LOC_GOODYHUT_VILLAGER_SECRETS_DESCRIPTION', 100, 0, 1, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_SECRETS', 'GOODYHUT_VILLAGER_SECRETS_PRODUCTION', 'LOC_GOODYHUT_VILLAGER_SECRETS_DESCRIPTION', 100, 0, 1, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    ('GOODYHUT_SECRETS', 'GOODYHUT_VILLAGER_SECRETS_SCIENCE', 'LOC_GOODYHUT_VILLAGER_SECRETS_DESCRIPTION', 100, 0, 1, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    -- Fallback rewards - these help prevent infinite loops and crashes related to EGHV; they should not be enabled or normally accessible
    ('GOODYHUT_FALLBACK', 'GOODYHUT_CULTURE_FALLBACK', 'LOC_GOODYHUT_CULTURE_FALLBACK_DESCRIPTION', 0, 0, 0, 0, 'GOODY_FALLBACK_CULTURE'),
    ('GOODYHUT_FALLBACK', 'GOODYHUT_FAITH_FALLBACK', 'LOC_GOODYHUT_FAITH_FALLBACK_DESCRIPTION', 0, 0, 0, 0, 'GOODY_FALLBACK_FAITH'),
    -- ('GOODYHUT_FALLBACK', 'GOODYHUT_FOOD_FALLBACK', 'LOC_GOODYHUT_FOOD_FALLBACK_DESCRIPTION', 0, 0, 0, 0, 'GOODY_FALLBACK_FOOD'),
    ('GOODYHUT_FALLBACK', 'GOODYHUT_GOLD_FALLBACK', 'LOC_GOODYHUT_GOLD_FALLBACK_DESCRIPTION', 0, 0, 0, 0, 'GOODY_FALLBACK_GOLD'),
    -- ('GOODYHUT_FALLBACK', 'GOODYHUT_PRODUCTION_FALLBACK', 'LOC_GOODYHUT_PRODUCTION_FALLBACK_DESCRIPTION', 0, 0, 0, 0, 'GOODY_FALLBACK_PRODUCTION'),
    ('GOODYHUT_FALLBACK', 'GOODYHUT_SCIENCE_FALLBACK', 'LOC_GOODYHUT_SCIENCE_FALLBACK_DESCRIPTION', 0, 0, 0, 0, 'GOODY_FALLBACK_SCIENCE');
...
VALUES
    ...
    -- Hostile Villagers : unit XP modifier (the actual heavy-lifting here is done via lua) *** 2023/04/04 unused ***
    ...
    -- Promotions : huge lump XP sum *** 2023/04/04 unused ***
    ...
    -- food fallback - this helps prevent infinite loops and crashes related to EGHV; it should not be enabled or normally accessible *** 2023/04/04 does not work ***
    ...
    -- production fallback - this helps prevent infinite loops and crashes related to EGHV; it should not be enabled or normally accessible *** 2023/04/04 does not work ***
