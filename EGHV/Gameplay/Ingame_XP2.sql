...
REPLACE INTO DisabledGoodyHutSubTypes SELECT * FROM GoodyHutSubTypes WHERE SubTypeGoodyHut = 'GOODYHUT_FAVOR';
...
REPLACE INTO DisabledGoodyHutSubTypes SELECT * FROM GoodyHutSubTypes WHERE SubTypeGoodyHut = 'GOODYHUT_ENVOY';
DELETE FROM GoodyHutSubTypes WHERE SubTypeGoodyHut = 'GOODYHUT_ENVOY';
-- UPDATE GoodyHutSubTypes SET Weight = 0, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_GOVERNOR_TITLE';        -- defaults : Weight = 15, Turn = 30
REPLACE INTO DisabledGoodyHutSubTypes SELECT * FROM GoodyHutSubTypes WHERE SubTypeGoodyHut = 'GOODYHUT_GOVERNOR_TITLE';
DELETE FROM GoodyHutSubTypes WHERE SubTypeGoodyHut = 'GOODYHUT_GOVERNOR_TITLE';
...
REPLACE INTO DisabledGoodyHutSubTypes SELECT * FROM GoodyHutSubTypes WHERE SubTypeGoodyHut LIKE '%GOODYHUT_GRANT_EXPERIENCE%';
DELETE FROM GoodyHutSubTypes WHERE SubTypeGoodyHut LIKE '%GOODYHUT_GRANT_EXPERIENCE%';
-- UPDATE GoodyHutSubTypes SET Weight = 0, Turn = 0 WHERE SubTypeGoodyHut = 'GOODYHUT_RESOURCES';             -- defaults : Weight = 20
REPLACE INTO DisabledGoodyHutSubTypes SELECT * FROM GoodyHutSubTypes WHERE SubTypeGoodyHut = 'GOODYHUT_RESOURCES';
...
VALUES
    -- Secrets : favor villager totem
    ('GOODYHUT_SECRETS', 'GOODYHUT_VILLAGER_SECRETS_FAVOR', 'LOC_GOODYHUT_VILLAGER_SECRETS_DESCRIPTION', 100, 0, 1, 0, 'GOODY_EGHV_DUMMY_REWARD'),
    -- Diplomacy
    ('GOODYHUT_DIPLOMACY', 'GOODYHUT_SMALL_FAVOR', 'LOC_GOODYHUT_SMALL_FAVOR_DESCRIPTION', 55, 0, 0, 0, 'GOODY_FAVOR_SMALL_MODIFIER'),
    ('GOODYHUT_DIPLOMACY', 'GOODYHUT_MEDIUM_FAVOR', 'LOC_GOODYHUT_MEDIUM_FAVOR_DESCRIPTION', 30, 0, 0, 0, 'GOODY_FAVOR_MEDIUM_MODIFIER'),
    ('GOODYHUT_DIPLOMACY', 'GOODYHUT_LARGE_FAVOR', 'LOC_GOODYHUT_LARGE_FAVOR_DESCRIPTION', 10, 0, 0, 0, 'GOODY_FAVOR_LARGE_MODIFIER'),
    ('GOODYHUT_DIPLOMACY', 'GOODYHUT_HUGE_FAVOR', 'LOC_GOODYHUT_HUGE_FAVOR_DESCRIPTION', 5, 0, 0, 0, 'GOODY_FAVOR_HUGE_MODIFIER'),
    -- Resources
    ('GOODYHUT_RESOURCES', 'GOODYHUT_SMALL_RESOURCES', 'LOC_GOODYHUT_SMALL_RESOURCES_DESCRIPTION', 55, 0, 0, 0, 'GOODY_RESOURCES_SMALL_MODIFIER'),
    ('GOODYHUT_RESOURCES', 'GOODYHUT_MEDIUM_RESOURCES', 'LOC_GOODYHUT_MEDIUM_RESOURCES_DESCRIPTION', 30, 0, 0, 0, 'GOODY_RESOURCES_MEDIUM_MODIFIER'),
    ('GOODYHUT_RESOURCES', 'GOODYHUT_LARGE_RESOURCES', 'LOC_GOODYHUT_LARGE_RESOURCES_DESCRIPTION', 10, 0, 0, 0, 'GOODY_RESOURCES_LARGE_MODIFIER'),
    ('GOODYHUT_RESOURCES', 'GOODYHUT_HUGE_RESOURCES', 'LOC_GOODYHUT_HUGE_RESOURCES_DESCRIPTION', 5, 0, 0, 0, 'GOODY_RESOURCES_HUGE_MODIFIER');
